...
public class TdoaLateration
{
    ...
    /// <returns></returns>
    public static TargetCalcResult TDOA_Locate2D_WithOptimalArgs(TOABasePoint[] basePoints, double xPrev = 0, double yPrev= 0)
        => TDOA_Locate2D(basePoints, xPrev, yPrev, Z_TAG, MAX_ITER_DEF, PREC_THR_DEF, SIMPLEX_SIZE_DEF, PhysicalConstants.SpeedOfLight);
        ...
        /// <returns></returns>
        public static TargetCalcResult TDOA_Locate2D(TOABasePoint[] basePoints,
                                     ...
                                     double velocity)
    {
        ...
        return new TargetCalcResult(xBest, yBest, radialError, itCnt);
